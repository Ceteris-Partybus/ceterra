    ...
    void Start() {
        ...
        for (int i = 0; i < splines.Count(); i++) {
            ...
            for (int k = 0; k < knots.Count(); k++) {
                ...
                var field = new Field(physicalKnotId++, i, fieldType, new SplineKnotIndex(i, k));
                fields.Add(field);

                GameObject fieldGameObject = Instantiate(fieldPrefab, knot.Position, Quaternion.identity);
