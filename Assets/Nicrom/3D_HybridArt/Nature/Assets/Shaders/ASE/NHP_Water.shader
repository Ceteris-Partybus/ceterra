	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float distanceDepth205 = abs( ( screenDepth205 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _EdgeBlend ) );
				float switchResult208 = (((isFrontFace>0)?(( V.y * distanceDepth205 )):(( distanceDepth205 * -V.y ))));
				...
				float eyeDepth411 = LinearEyeDepth(SampleCameraDepth( float4( ScreenUVsWithDistortion17, 0.0 , 0.0 ).xy ),_ZBufferParams);
				float2 lerpResult424 = lerp( appendResult419 , ScreenUVsWithDistortion17 , step( screenPos.w , eyeDepth411 ));
				float2 RefractionsUVs420 = lerpResult424;
				float4 fetchOpaqueVal155 = ASEHDSampleSceneColor(RefractionsUVs420, 0.0, GetInverseCurrentExposureMultiplier());
				float4 Refraction379 = fetchOpaqueVal155;
				float WaterDepth431 = _WaterDepth;
				float eyeDepth426 = LinearEyeDepth(SampleCameraDepth( float4( RefractionsUVs420, 0.0 , 0.0 ).xy ),_ZBufferParams);
				float DepthOfDist435 = saturate( ( WaterDepth431 / abs( ( eyeDepth426 - screenPos.w ) ) ) );
				...
				float screenDepth344 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth344 = abs( ( screenDepth344 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( ( ( sin( ( ( _TimeParameters.x ) * _FoamSpeed ) ) * _FoamDepthOffset ) + _FoamDepth ) ) );
				float switchResult348 = (((isFrontFace>0)?(( V.y * distanceDepth344 )):(( distanceDepth344 * -V.y ))));
				...
				float screenDepth184 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth184 = abs( ( screenDepth184 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( WaterDepth431 ) );
				float switchResult190 = (((isFrontFace>0)?(( V.y * distanceDepth184 )):(( distanceDepth184 * -V.y ))));
				...
				surfaceDescription.BaseColor = FinalColor157.rgb;
				surfaceDescription.Normal = Normals10;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float screenDepth205 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth205 = abs( ( screenDepth205 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _EdgeBlend ) );
				float switchResult208 = (((isFrontFace>0)?(( ase_worldViewDir.y * distanceDepth205 )):(( distanceDepth205 * -ase_worldViewDir.y ))));
				float EdgeOpacity210 = saturate( switchResult208 );
				float2 DistortionUVs589 = ( ( ( 0.5 * ( (UnpackNormalScale( tex2D( _DistortionTexture, ( ( temp_output_655_0 * (_DistTilingMap1XYMap2ZW).xy ) + ( (_DistSpeedMap1XYMap2ZW).xy * ( _TimeParameters.x ) ) ) ), 1.0f )).xy + (UnpackNormalScale( tex2D( _DistortionTexture, ( ( temp_output_655_0 * (_DistTilingMap1XYMap2ZW).zz ) + ( ( _TimeParameters.x ) * (_DistSpeedMap1XYMap2ZW).zw ) ) ), 1.0f )).xy ) ) * 0.1 * _Distortion ) * EdgeOpacity210 );
				#ifdef _ENABLEDISTORTION_ON
				float2 staticSwitch694 = ( appendResult7 - DistortionUVs589 );
				...
				float screenDepth344 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth344 = abs( ( screenDepth344 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( ( ( sin( ( ( _TimeParameters.x ) * _FoamSpeed ) ) * _FoamDepthOffset ) + _FoamDepth ) ) );
				float switchResult348 = (((isFrontFace>0)?(( ase_worldViewDir.y * distanceDepth344 )):(( distanceDepth344 * -ase_worldViewDir.y ))));
				float FoamLine297 = ( 1.0 - saturate( ( _FoamWidth * saturate( switchResult348 ) ) ) );
				#ifdef _ENABLEFOAM_ON
				float staticSwitch312 = FoamLine297;
				#else
				...
				float screenDepth184 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth184 = abs( ( screenDepth184 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( WaterDepth431 ) );
				float switchResult190 = (((isFrontFace>0)?(( ase_worldViewDir.y * distanceDepth184 )):(( distanceDepth184 * -ase_worldViewDir.y ))));
				float DepthFade77 = saturate( switchResult190 );
				float3 unpack2 = UnpackNormalScale( tex2D( _NormalMap, -UV133 ), ( _Map1Strength * DepthFade77 ) );
				unpack2.z = lerp( 1, unpack2.z, saturate(( _Map1Strength * DepthFade77 )) );
				float2 appendResult645 = (float2(_TilingMap1XYMap2ZW.z , _TilingMap1XYMap2ZW.w));
...
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;201;-3565.105,-57.28735;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.CommentaryNode;142;641.5489,775.5737;Inherit;False;1727.085;511.5074;;14;157;392;400;692;596;597;408;298;401;312;502;299;315;402;Final Water Color;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;359;2573.932,711.441;Inherit;False;755.0811;634.8221;;5;212;194;690;193;100;Master Node;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;193;2693.218,861.5743;Inherit;False;10;Normals;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;100;2699.956,767.6589;Inherit;False;157;FinalColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;692;1510.639,888.2155;Inherit;False;379;Refraction;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;400;956.9462,861.6989;Inherit;False;379;Refraction;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;392;940.9462,953.6987;Inherit;False;373;DepthColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;417;-374.0559,-22.1822;Inherit;False;17;ScreenUVsWithDistortion;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;412;-801.7549,213.3831;Inherit;False;17;ScreenUVsWithDistortion;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ScreenPosInputsNode;414;-531.8907,34.39168;Float;False;1;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;420;118.6359,-72.283;Inherit;False;RefractionsUVs;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ScreenDepthNode;411;-537.7745,212.423;Inherit;False;0;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;421;-369.1578,313.0353;Inherit;False;420;RefractionsUVs;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;379;85.52495,309.4964;Inherit;False;Refraction;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;91;-3652.692,1192.278;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TimeNode;649;-4946.659,1459.715;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-3885.771,1160.924;Inherit;False;Property;_Map1Strength;Map1 Strength;9;0;Create;True;0;0;0;False;0;False;0.3;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;92;-3891.015,1240.767;Inherit;False;77;DepthFade;1;0;OBJECT;;False;1;FLOAT;0
...
WireConnection;695;0;100;0
WireConnection;695;1;193;0
WireConnection;695;4;690;0
WireConnection;695;7;194;0
WireConnection;695;9;212;0
ASEEND*/
//CHKSM=8AD7A39AD1142341BAD901DFE9E747C30CB1DBC6