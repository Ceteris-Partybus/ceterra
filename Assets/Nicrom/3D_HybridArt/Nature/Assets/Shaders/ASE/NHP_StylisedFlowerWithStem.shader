...
Shader "Nicrom/NHP/ASE/Stylised Flower With Stem"
{
	Properties
	{
		...
		[NoScaleOffset][SingleLineTexture][Header(Surface)][Space]_MainTex("Flower Texture", 2D) = "white" {}
		[NoScaleOffset][SingleLineTexture]_StemTexture("Stem Texture", 2D) = "white" {}
		[Space]_FlowerColor1("Flower Color 1", Color) = (0.7843137,0.454902,0.1411765,1)
		_FlowerColor2("Flower Color 2", Color) = (0.8980392,0.9529412,1,1)
		[Space]_ColorBlendStart("Color Blend Start", Range( 0 , 1)) = 0.1
		_ColorBlendEnd("Color Blend End", Range( 0 , 1)) = 0.15
		[Space]_StemColor("Stem Color", Color) = (0.3960784,0.5647059,0.1019608,1)
		...
		[Header(Rotation Around Local Pivot)][Space][Toggle(_ENABLEROTATION_ON)] _EnableRotation("Enable Rotation", Float) = 1
		[Space]_RotationAmplitude("Rotation Amplitude", Float) = 2
		_RotationFrequency("Rotation Frequency", Float) = 1.16
		_RotationPhase("Rotation Phase", Float) = 1
		[Space]_RotationMaxRadius("Rotation Max Radius", Float) = 0.05
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 objToWorld11_g99 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( LocalPivot1504, 1 ) ).xyz);
				...
				float3 worldToObj35_g130 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(appendResult14_g130), 1 ) ).xyz;
				float3 worldToObj36_g130 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(float3( 0,0,0 )), 1 ) ).xyz;
				...
				float3 objToWorld52_g129 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float3 appendResult45_g131 = (float3(break62_g131.x , inputMesh.positionOS.y , break62_g131.z));
				float3 rotatedValue30_g131 = RotateAroundAxis( appendResult45_g131, inputMesh.positionOS, RotationAxis56_g131, RotationAngle54_g131 );
				float DB_HorizontalAmplitude1221 = _RotationAmplitude;
				float DB_HorizontalFrequency1219 = _RotationFrequency;
				float Frequency41_g115 = DB_HorizontalFrequency1219;
				float3 objToWorld53_g115 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float DB_HorizontalPhase1401 = _RotationPhase;
				float3 PivotPoint49_g115 = LocalPivot1504;
				float3 break52_g115 = PivotPoint49_g115;
				float3 appendResult20_g115 = (float3(break52_g115.x , inputMesh.positionOS.y , break52_g115.z));
				float DB_HorizontalMaxRadius1403 = _RotationMaxRadius;
				float3 rotatedValue33_g115 = RotateAroundAxis( PivotPoint49_g115, inputMesh.positionOS, float3(0,1,0), radians( ( ( DB_HorizontalAmplitude1221 * sin( ( ( ( ( _TimeParameters.x ) * Frequency41_g115 ) - ( ( 2.0 * PI ) * ( 1.0 - DB_PhaseShift928 ) ) ) + ( ( ( objToWorld53_g115.x + objToWorld53_g115.z ) + ( ( _TimeParameters.x ) * Frequency41_g115 ) ) * DB_HorizontalPhase1401 ) ) ) ) * ( distance( inputMesh.positionOS , appendResult20_g115 ) / DB_HorizontalMaxRadius1403 ) ) ) );
				#ifdef _ENABLEROTATION_ON
				float3 staticSwitch1214 = ( ( rotatedValue33_g115 - inputMesh.positionOS ) * 1.0 );
				#else
				...
				float3 temp_output_1533_0 = ( ( rotatedValue34_g131 - inputMesh.positionOS ) * step( 0.01 , inputMesh.positionOS.y ) );
				float3 MainBending89_g133 = temp_output_1533_0;
				float3 appendResult15_g133 = (float3(0.0 , 1.0 , 0.0));
				float3 objToWorld98_g133 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( appendResult15_g133, 1 ) ).xyz);
				float3 objToWorld102_g133 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float3 break20_g133 = ( objToWorld98_g133 - objToWorld102_g133 );
				float3 appendResult24_g133 = (float3(-break20_g133.z , 0.0 , break20_g133.x));
				float3 appendResult3_g133 = (float3(0.0 , 1.0 , 0.0));
				float3 objToWorld100_g133 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( appendResult3_g133, 1 ) ).xyz);
				float3 objToWorld106_g133 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float3 temp_output_107_0_g133 = ( objToWorld100_g133 - objToWorld106_g133 );
				float3 break108_g133 = temp_output_107_0_g133;
				float3 lerpResult84_g133 = lerp( float3(0,1,0) , temp_output_107_0_g133 , step( 0.001 , ( abs( break108_g133.x ) + abs( break108_g133.z ) ) ));
				...
				float NaNPrevention21_g133 = step( 0.01 , abs( ( temp_output_12_0_g133 * ( 180.0 / PI ) ) ) );
				float3 lerpResult26_g133 = lerp( float3(1,0,0) , appendResult24_g133 , NaNPrevention21_g133);
				float3 worldToObj99_g133 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(lerpResult26_g133), 1 ) ).xyz;
				float3 worldToObj105_g133 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(float3( 0,0,0 )), 1 ) ).xyz;
				float3 normalizeResult49_g133 = normalize( ( worldToObj99_g133 - worldToObj105_g133 ) );
				...
				float3 rotatedValue35_g133 = RotateAroundAxis( LocalPivot1504, ( inputMesh.positionOS + MainBending89_g133 ), RotationAxis30_g133, RotationAngle29_g133 );
				float3 lerpResult52_g133 = lerp( MainBending89_g133 , ( rotatedValue35_g133 - inputMesh.positionOS ) , NaNPrevention21_g133);
						...
						)
			{
				...
				float2 uv_StemTexture1482 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode1482 = tex2D( _StemTexture, uv_StemTexture1482 );
				float TextureMask1458 = step( 1.5 , packedInput.ase_texcoord5.xy.x );
				float4 lerpResult1486 = lerp( tex2DNode1481 , tex2DNode1482 , TextureMask1458);
				float4 TextureColor1487 = lerpResult1486;
				float DistanceToCenter1466 = distance( float2( 0.5,0.5 ) , packedInput.ase_texcoord5.xy );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode1481 = tex2D( _MainTex, uv_MainTex1481 );
				float2 uv_StemTexture1482 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode1482 = tex2D( _StemTexture, uv_StemTexture1482 );
				float TextureMask1458 = step( 1.5 , packedInput.ase_texcoord2.xy.x );
				float4 lerpResult1486 = lerp( tex2DNode1481 , tex2DNode1482 , TextureMask1458);
				float4 TextureColor1487 = lerpResult1486;
				float DistanceToCenter1466 = distance( float2( 0.5,0.5 ) , packedInput.ase_texcoord2.xy );
				float ColorBlendStart1506 = _ColorBlendStart;
				float ColorBlendEnd1812 = _ColorBlendEnd;
				float4 lerpResult1480 = lerp( _FlowerColor1 , _FlowerColor2 , ( saturate( ( ( DistanceToCenter1466 - ColorBlendStart1506 ) / ColorBlendEnd1812 ) ) * step( ColorBlendStart1506 , DistanceToCenter1466 ) ));
				float4 lerpResult1485 = lerp( lerpResult1480 , _StemColor , TextureMask1458);
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float4 tex2DNode1481 = tex2D( _MainTex, uv_MainTex1481 );
				float2 uv_StemTexture1482 = packedInput.ase_texcoord1.xy;
				float4 tex2DNode1482 = tex2D( _StemTexture, uv_StemTexture1482 );
				float TextureMask1458 = step( 1.5 , packedInput.ase_texcoord1.xy.x );
				float lerpResult1492 = lerp( tex2DNode1481.a , tex2DNode1482.a , TextureMask1458);
				float Opacity1494 = lerpResult1492;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float4 tex2DNode1481 = tex2D( _MainTex, uv_MainTex1481 );
				float2 uv_StemTexture1482 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode1482 = tex2D( _StemTexture, uv_StemTexture1482 );
				float TextureMask1458 = step( 1.5 , packedInput.ase_texcoord3.xy.x );
				float lerpResult1492 = lerp( tex2DNode1481.a , tex2DNode1482.a , TextureMask1458);
				float Opacity1494 = lerpResult1492;
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode1481 = tex2D( _MainTex, uv_MainTex1481 );
				float2 uv_StemTexture1482 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode1482 = tex2D( _StemTexture, uv_StemTexture1482 );
				float TextureMask1458 = step( 1.5 , packedInput.ase_texcoord7.xy.x );
				float4 lerpResult1486 = lerp( tex2DNode1481 , tex2DNode1482 , TextureMask1458);
				float4 TextureColor1487 = lerpResult1486;
				float DistanceToCenter1466 = distance( float2( 0.5,0.5 ) , packedInput.ase_texcoord7.xy );
				float ColorBlendStart1506 = _ColorBlendStart;
				float ColorBlendEnd1812 = _ColorBlendEnd;
				float4 lerpResult1480 = lerp( _FlowerColor1 , _FlowerColor2 , ( saturate( ( ( DistanceToCenter1466 - ColorBlendStart1506 ) / ColorBlendEnd1812 ) ) * step( ColorBlendStart1506 , DistanceToCenter1466 ) ));
				float4 lerpResult1485 = lerp( lerpResult1480 , _StemColor , TextureMask1458);
...
Node;AmplifyShaderEditor.Vector4Node;1815;-2824.401,2509.249;Inherit;False;Property;_NoiseTextureTilling;Noise Tilling - Static (XY), Animated (ZW);26;0;Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;1814;-2754.401,2682.25;Float;False;Property;_NoisePannerSpeed;Noise Panner Speed;27;0;Create;True;0;0;0;False;0;False;0.05,0.03;0.08,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;1810;-4809.595,3300.19;Inherit;False;Property;_MBWindDirBlend;MB Wind Dir Blend;15;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1538;-2755.761,2310.993;Inherit;True;Property;_NoiseTexture;Noise Texture;25;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;2;Header(World Space Noise);Space;False;None;512fa11ad89d84543ad8d6c8d9cb6743;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;850;-4810.689,3122.742;Float;False;Property;_MBWindDir;MB Wind Dir;13;0;Create;True;0;0;0;False;1;Space;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1220;-4032.775,2386.569;Float;False;Property;_RotationAmplitude;Rotation Amplitude;18;0;Create;True;0;0;0;False;1;Space;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1218;-4032.775,2483.569;Float;False;Property;_RotationFrequency;Rotation Frequency;19;0;Create;True;0;0;0;False;0;False;1.16;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1308;-4030.775,2579.569;Float;False;Property;_RotationPhase;Rotation Phase;20;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1249;-4032.775,2675.569;Float;False;Property;_RotationMaxRadius;Rotation Max Radius;21;0;Create;True;0;0;0;False;1;Space;False;0.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1524;-4811.99,2929.007;Inherit;False;Property;_MBFrequencyOffset;MB Frequency Offset;11;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;952;-4805.979,3394.934;Float;False;Property;_MBWindDirOffset;MB Wind Dir Offset;14;0;Create;True;0;0;0;False;0;False;20;0;0;180;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1262;-4814.087,2738.873;Float;False;Property;_MBAmplitudeOffset;MB Amplitude Offset;9;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;687;-4814.087,2546.874;Float;False;Property;_MBDefaultBending;MB Default Bending;7;0;Create;True;0;0;0;False;2;Header(Main Bending);Space;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;300;-4814.087,2642.873;Float;False;Property;_MBAmplitude;MB Amplitude;8;0;Create;True;0;0;0;False;1;Space;False;1.5;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;480;-4814.087,2834.873;Float;False;Property;_MBFrequency;MB Frequency;10;0;Create;True;0;0;0;False;1;Space;False;1.11;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1286;-4810.689,3025.742;Float;False;Property;_MBPhase;MB Phase;12;0;Create;True;0;0;0;False;1;Space;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1334;-4808.824,3517.175;Inherit;False;Property;_MBMaxHeight;MB Max Height;16;0;Create;True;0;0;0;False;1;Space;False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;1214;-2265.668,3263.249;Float;False;Property;_EnableRotation;Enable Rotation;17;0;Create;True;0;0;0;False;2;Header(Rotation Around Local Pivot);Space;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1804;-4034.173,2886.452;Inherit;False;Property;_SlopeCorrectionOffset;Slope Correction Offset;24;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1774;-4030.819,2787.221;Inherit;False;Property;_SlopeCorrectionMagnitude;Slope Correction Magnitude;23;0;Create;True;0;0;0;False;1;Space;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1481;-337.8076,1668.115;Inherit;True;Property;_MainTex;Flower Texture;0;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;2;Header(Surface);Space;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;1482;-331.9526,1969.693;Inherit;True;Property;_StemTexture;Stem Texture;1;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.StaticSwitch;1781;936.2124,2848.605;Float;False;Property;_EnableSlopeCorrection;Enable Slope Correction;22;0;Create;True;0;0;0;False;2;Header(Slope Correction);Space;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;1265;1923.979,2049.843;Inherit;False;631.4954;512.0168;;5;1508;1574;296;1818;1816;Master Node;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1470;-4803.965,2453.833;Inherit;False;Property;_ColorBlendEnd;Color Blend End;5;0;Create;True;0;0;0;False;0;False;0.15;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1476;551.7269,1072.368;Inherit;False;Property;_FlowerColor2;Flower Color 2;3;0;Create;True;0;0;0;False;0;False;0.8980392,0.9529412,1,1;0.009433985,0.4014694,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
WireConnection;1818;0;296;0
WireConnection;1818;4;1816;0
WireConnection;1818;7;1816;0
WireConnection;1818;9;1508;0
WireConnection;1818;11;1574;0
ASEEND*/
//CHKSM=894BC02645F31A4D9FF00210B8C9B2DC8E24FEF0