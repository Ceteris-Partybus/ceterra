	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord1524 = inputMesh.uv1.xy * float2( 1,1 ) + float2( 0,0 );
				float3 appendResult1525 = (float3(texCoord1524.x , 0.0 , texCoord1524.y));
				float3 MB_LocalPivot1526 = -appendResult1525;
				float3 objToWorld11_g110 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( MB_LocalPivot1526, 1 ) ).xyz);
				...
				float3 worldToObj35_g114 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(appendResult14_g114), 1 ) ).xyz;
				float3 worldToObj36_g114 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(float3( 0,0,0 )), 1 ) ).xyz;
				...
				float3 appendResult45_g115 = (float3(break62_g115.x , inputMesh.positionOS.y , break62_g115.z));
				float3 rotatedValue30_g115 = RotateAroundAxis( appendResult45_g115, inputMesh.positionOS, RotationAxis56_g115, RotationAngle54_g115 );
				...
				float3 temp_output_1483_0 = ( ( rotatedValue34_g115 - inputMesh.positionOS ) * step( 0.01 , inputMesh.positionOS.y ) );
				float3 MainBending89_g116 = temp_output_1483_0;
				float3 appendResult15_g116 = (float3(0.0 , 1.0 , 0.0));
				float3 objToWorld98_g116 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( appendResult15_g116, 1 ) ).xyz);
				float3 objToWorld102_g116 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float3 objToWorld100_g116 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( appendResult3_g116, 1 ) ).xyz);
				float3 objToWorld106_g116 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float3 worldToObj99_g116 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(lerpResult26_g116), 1 ) ).xyz;
				float3 worldToObj105_g116 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(float3( 0,0,0 )), 1 ) ).xyz;
				...
				float3 rotatedValue35_g116 = RotateAroundAxis( MB_LocalPivot1526, ( inputMesh.positionOS + MainBending89_g116 ), RotationAxis30_g116, RotationAngle29_g116 );
				float3 lerpResult52_g116 = lerp( MainBending89_g116 , ( rotatedValue35_g116 - inputMesh.positionOS ) , NaNPrevention21_g116);
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float MB_WindDirection870 = lerpResult1541;
				float MB_WindDirectionVariation1373 = _MBWindDirOffset;
				float2 texCoord1524 = inputMesh.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float3 appendResult1525 = (float3(texCoord1524.x , 0.0 , texCoord1524.y));
				float3 MB_LocalPivot1526 = -appendResult1525;
				float3 objToWorld11_g110 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( MB_LocalPivot1526, 1 ) ).xyz);
				float2 appendResult10_g110 = (float2(objToWorld11_g110.x , objToWorld11_g110.z));
...
Node;AmplifyShaderEditor.RangedFloatNode;1540;-4675.813,3198.611;Inherit;False;Property;_MBWindDirBlend;MB Wind Dir Blend;11;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;1537;-3228.792,3548.592;Float;False;Property;_NoisePannerSpeed;Noise Panner Speed;18;0;Create;True;0;0;0;False;0;False;0.05,0.03;0.08,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector4Node;1538;-3292.792,3370.591;Inherit;False;Property;_NoiseTextureTilling;Noise Tilling - Static (XY), Animated (ZW);17;0;Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;850;-4678.628,3020.549;Float;False;Property;_MBWindDir;MB Wind Dir;9;0;Create;True;0;0;0;False;1;Space;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1510;-3228.404,3168.387;Inherit;True;Property;_NoiseTexture;Noise Texture;16;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;2;Header(World Space Noise);Space;False;None;512fa11ad89d84543ad8d6c8d9cb6743;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;952;-4668.996,3309.735;Float;False;Property;_MBWindDirOffset;MB Wind Dir Offset;10;0;Create;True;0;0;0;False;0;False;20;0;0;180;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1473;-4680.551,2819.459;Inherit;False;Property;_MBFrequencyOffset;MB Frequency Offset;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1262;-4682.929,2630.848;Float;False;Property;_MBAmplitudeOffset;MB Amplitude Offset;5;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;687;-4682.929,2438.849;Float;False;Property;_MBDefaultBending;MB Default Bending;3;0;Create;True;0;0;0;False;2;Header(Main Bending);Space;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;300;-4682.929,2534.848;Float;False;Property;_MBAmplitude;MB Amplitude;4;0;Create;True;0;0;0;False;1;Space;False;1.5;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;480;-4682.929,2726.848;Float;False;Property;_MBFrequency;MB Frequency;6;0;Create;True;0;0;0;False;1;Space;False;1.11;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1286;-4678.628,2907.549;Float;False;Property;_MBPhase;MB Phase;8;0;Create;True;0;0;0;False;1;Space;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1334;-4668.174,3409.694;Inherit;False;Property;_MBMaxHeight;MB Max Height;12;0;Create;True;0;0;0;False;1;Space;False;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1542;-4666.67,3618.679;Inherit;False;Property;_SlopeCorrectionOffset;Slope Correction Offset;15;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1530;-4665.996,3522.735;Inherit;False;Property;_SlopeCorrectionMagnitude;Slope Correction Magnitude;14;0;Create;True;0;0;0;False;1;Space;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;1535;491.172,2939.431;Float;False;Property;_EnableSlopeCorrection;Enable Slope Correction;13;0;Create;True;0;0;0;False;2;Header(Slope Correction);Space;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;1265;1539.624,2815.101;Inherit;False;631.4954;627.4399;;4;296;1522;1523;1061;Master Node;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1523;1569.788,3069.359;Inherit;False;Property;_Smoothness;Smoothness;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
WireConnection;1549;0;296;0
WireConnection;1549;4;1522;0
WireConnection;1549;7;1523;0
WireConnection;1549;11;1061;0
ASEEND*/
//CHKSM=7384CE24B52393BF45067B8C5D2F2DA6C2E8FF14