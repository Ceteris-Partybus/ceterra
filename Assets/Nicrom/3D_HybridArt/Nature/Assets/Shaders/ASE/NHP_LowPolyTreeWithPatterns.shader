...
Shader "Nicrom/NHP/ASE/Low Poly Tree With Patterns"
{
	Properties
	{
		...
		[NoScaleOffset][SingleLineTexture][Header(Surface)][Space]_MainTex("Main Texture", 2D) = "white" {}
		[NoScaleOffset][SingleLineTexture]_PatternTex("Pattern Texture", 2D) = "white" {}
		[Space]_PatternColor1("Pattern Color 1", Color) = (1,1,1,1)
		...
		[Header(Vertical Detail Bending)][Space][Toggle(_ENABLEVERTICALBENDING_ON)] _EnableVerticalBending("Enable Vertical Bending", Float) = 1
		[Space]_DBVerticalAmplitude("DB Vertical Amplitude", Float) = 1
		_DBVerticalAmplitudeOffset("DB Vertical Amplitude Offset", Float) = 1.2
		[Space]_DBVerticalFrequency("DB Vertical Frequency", Float) = 1.15
		_DBVerticalPhase("DB Vertical Phase", Float) = 1
		[Space]_DBVerticalMaxLength("DB Vertical Max Length", Float) = 2
		[Header(Horizontal Detail Bending)][Space][Toggle(_ENABLEHORIZONTALBENDING_ON)] _EnableHorizontalBending("Enable Horizontal Bending", Float) = 1
		[Space]_DBHorizontalAmplitude("DB Horizontal Amplitude", Float) = 2
		_DBHorizontalFrequency("DB Horizontal Frequency", Float) = 1.16
		_DBHorizontalPhase("DB Horizontal Phase", Float) = 1
		[Space]_DBHorizontalMaxRadius("DB Horizontal Max Radius", Float) = 2
		[NoScaleOffset][SingleLineTexture][Header(World Space Noise)][Space]_NoiseTexture("Noise Texture", 2D) = "white" {}
		...
		[Header(Misc)][Space]_UnitScale("Unit Scale", Float) = 20
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 objToWorld1533 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float2 appendResult1502 = (float2(objToWorld1533.x , objToWorld1533.z));
				...
				float3 worldToObj35_g92 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(appendResult14_g92), 1 ) ).xyz;
				float3 worldToObj36_g92 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(float3( 0,0,0 )), 1 ) ).xyz;
				...
				float3 objToWorld52_g91 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float MB_RotationAngle97 = radians( ( ( ( ( MB_Amplitude880 + ( MB_AmplitudeOffset1356 * (StaticWorldNoise31_g91).x ) ) * sin( ( ( ( objToWorld52_g91.x + objToWorld52_g91.z ) + ( ( ( _TimeParameters.x ) * ( MB_Frequency873 + ( MB_FrequencyOffset1483 * (StaticWorldNoise31_g91).x ) ) ) + ( ( 2.0 * PI ) * 0.0 ) ) ) * MB_Phase1360 ) ) ) + MB_DefaultBending877 ) * ( inputMesh.positionOS.y / MB_MaxHeight1335 ) ) );
				float RotationAngle54_g93 = MB_RotationAngle97;
				float3 PivotPoint60_g93 = float3( 0,0,0 );
				float3 break62_g93 = PivotPoint60_g93;
				float3 appendResult45_g93 = (float3(break62_g93.x , inputMesh.positionOS.y , break62_g93.z));
				float3 rotatedValue30_g93 = RotateAroundAxis( appendResult45_g93, inputMesh.positionOS, RotationAxis56_g93, RotationAngle54_g93 );
				float temp_output_4_0_g79 = radians( ( inputMesh.ase_color.b * 360.0 ) );
				...
				float DB_PhaseShift928 = inputMesh.ase_color.a;
				...
				float3 objToWorld59_g89 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float DB_VerticalPhase1384 = _DBVerticalPhase;
				float3 appendResult12_g79 = (float3(0.0 , ( _UnitScale * inputMesh.ase_color.g ) , 0.0));
				...
				float3 rotatedValue29_g89 = RotateAroundAxis( PivotPosOnYAxis56_g89, inputMesh.positionOS, DB_RotationAxis757, radians( ( ( ( DB_VerticalAmplitude887 + ( DB_VerticalAmplitudeOffset1423 * ( 1.0 - PhaseShift48_g89 ) ) ) * sin( ( ( ( ( _TimeParameters.x ) * Fequency45_g89 ) - ( ( 2.0 * PI ) * PhaseShift48_g89 ) ) + ( ( ( objToWorld59_g89.x + objToWorld59_g89.z ) + ( ( _TimeParameters.x ) * Fequency45_g89 ) ) * DB_VerticalPhase1384 ) ) ) ) * ( distance( inputMesh.positionOS , PivotPosOnYAxis56_g89 ) / DB_VerticalMaxLength1388 ) ) ) );
				float DetailBendingMask1499 = step( 1.5 , inputMesh.ase_texcoord.x );
				float3 DB_VerticalBending1314 = ( ( rotatedValue29_g89 - inputMesh.positionOS ) * DetailBendingMask1499 );
				...
				float3 objToWorld53_g88 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float DB_HorizontalPhase1401 = _DBHorizontalPhase;
				float3 PivotPoint49_g88 = float3( 0,0,0 );
				float3 break52_g88 = PivotPoint49_g88;
				float3 appendResult20_g88 = (float3(break52_g88.x , inputMesh.positionOS.y , break52_g88.z));
				float DB_HorizontalMaxRadius1403 = _DBHorizontalMaxRadius;
				float3 rotatedValue33_g88 = RotateAroundAxis( PivotPoint49_g88, inputMesh.positionOS, float3(0,1,0), radians( ( ( DB_HorizontalAmplitude1221 * sin( ( ( ( ( _TimeParameters.x ) * Frequency41_g88 ) - ( ( 2.0 * PI ) * ( 1.0 - DB_PhaseShift928 ) ) ) + ( ( ( objToWorld53_g88.x + objToWorld53_g88.z ) + ( ( _TimeParameters.x ) * Frequency41_g88 ) ) * DB_HorizontalPhase1401 ) ) ) ) * ( distance( inputMesh.positionOS , appendResult20_g88 ) / DB_HorizontalMaxRadius1403 ) ) ) );
				float3 DB_HorizontalBending1315 = ( ( rotatedValue33_g88 - inputMesh.positionOS ) * DetailBendingMask1499 );
				...
				float3 LocalVertexOffset1045 = ( ( rotatedValue34_g93 - inputMesh.positionOS ) * step( 0.01 , inputMesh.positionOS.y ) );
						...
						)
			{
				...
				float2 uv_PatternTex = packedInput.ase_texcoord5.xy * _PatternTex_ST.xy + _PatternTex_ST.zw;
				float4 lerpResult1467 = lerp( _PatternColor2 , _PatternColor1 , tex2D( _PatternTex, uv_PatternTex ));
				float TextureMask1456 = step( packedInput.ase_texcoord5.xy.y , -1.0 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float DB_VerticalMaxLength1388 = _DBVerticalMaxLength;
				float3 rotatedValue29_g89 = RotateAroundAxis( PivotPosOnYAxis56_g89, inputMesh.positionOS, DB_RotationAxis757, radians( ( ( ( DB_VerticalAmplitude887 + ( DB_VerticalAmplitudeOffset1423 * ( 1.0 - PhaseShift48_g89 ) ) ) * sin( ( ( ( ( _TimeParameters.x ) * Fequency45_g89 ) - ( ( 2.0 * PI ) * PhaseShift48_g89 ) ) + ( ( ( objToWorld59_g89.x + objToWorld59_g89.z ) + ( ( _TimeParameters.x ) * Fequency45_g89 ) ) * DB_VerticalPhase1384 ) ) ) ) * ( distance( inputMesh.positionOS , PivotPosOnYAxis56_g89 ) / DB_VerticalMaxLength1388 ) ) ) );
				float DetailBendingMask1499 = step( 1.5 , inputMesh.uv0.x );
				float3 DB_VerticalBending1314 = ( ( rotatedValue29_g89 - inputMesh.positionOS ) * DetailBendingMask1499 );
				#ifdef _ENABLEVERTICALBENDING_ON
				float3 staticSwitch960 = DB_VerticalBending1314;
				#else
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_PatternTex = packedInput.ase_texcoord2.xy * _PatternTex_ST.xy + _PatternTex_ST.zw;
				float4 lerpResult1467 = lerp( _PatternColor2 , _PatternColor1 , tex2D( _PatternTex, uv_PatternTex ));
				float TextureMask1456 = step( packedInput.ase_texcoord2.xy.y , -1.0 );
				float4 lerpResult1462 = lerp( tex2D( _MainTex, uv_MainTex ) , lerpResult1467 , TextureMask1456);
				float4 Albedo292 = lerpResult1462;
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_PatternTex = packedInput.ase_texcoord7.xy * _PatternTex_ST.xy + _PatternTex_ST.zw;
				float4 lerpResult1467 = lerp( _PatternColor2 , _PatternColor1 , tex2D( _PatternTex, uv_PatternTex ));
				float TextureMask1456 = step( packedInput.ase_texcoord7.xy.y , -1.0 );
				float4 lerpResult1462 = lerp( tex2D( _MainTex, uv_MainTex ) , lerpResult1467 , TextureMask1456);
				float4 Albedo292 = lerpResult1462;
...
Node;AmplifyShaderEditor.RangedFloatNode;989;-5604.563,4069.742;Float;False;Property;_UnitScale;Unit Scale;30;0;Create;True;0;0;0;False;2;Header(Misc);Space;False;20;20;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1308;-5383.727,3330.877;Float;False;Property;_DBHorizontalPhase;DB Horizontal Phase;25;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1301;-5383.727,2914.877;Float;False;Property;_DBVerticalPhase;DB Vertical Phase;20;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1218;-5383.727,3233.877;Float;False;Property;_DBHorizontalFrequency;DB Horizontal Frequency;24;0;Create;True;0;0;0;False;0;False;1.16;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;792;-5383.727,3010.877;Float;False;Property;_DBVerticalMaxLength;DB Vertical Max Length;21;0;Create;True;0;0;0;False;1;Space;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1288;-5383.727,2722.876;Float;False;Property;_DBVerticalAmplitudeOffset;DB Vertical Amplitude Offset;18;0;Create;True;0;0;0;False;0;False;1.2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;780;-5383.727,2819.877;Float;False;Property;_DBVerticalFrequency;DB Vertical Frequency;19;0;Create;True;0;0;0;False;1;Space;False;1.15;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;749;-5383.727,2626.877;Float;False;Property;_DBVerticalAmplitude;DB Vertical Amplitude;17;0;Create;True;0;0;0;False;1;Space;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1220;-5383.727,3138.877;Float;False;Property;_DBHorizontalAmplitude;DB Horizontal Amplitude;23;0;Create;True;0;0;0;False;1;Space;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1249;-5383.727,3426.877;Float;False;Property;_DBHorizontalMaxRadius;DB Horizontal Max Radius;26;0;Create;True;0;0;0;False;1;Space;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1500;-6017.013,1539.028;Inherit;False;1273.985;763.6335;Comment;8;1344;1340;1511;1518;1504;1502;1506;1533;World Position Noise;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TransformPositionNode;1533;-5951.228,1573.393;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1519;-6222.556,3363.691;Inherit;False;Property;_MBWindDirBlend;MB Wind Dir Blend;14;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;1506;-5814.558,2157.492;Float;False;Property;_NoisePannerSpeed;Noise Panner Speed;29;0;Create;True;0;0;0;False;0;False;0.1,0.1;0.08,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector4Node;1518;-5888.433,1976.041;Inherit;False;Property;_NoiseTextureTilling;Noise Tilling - Static (XY), Animated (ZW);28;0;Create;False;0;0;0;False;0;False;1,1,1,1;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;850;-6216.192,3198.146;Float;False;Property;_MBWindDir;MB Wind Dir;12;0;Create;True;0;0;0;False;1;Space;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1504;-5820.254,1775.649;Inherit;True;Property;_NoiseTexture;Noise Texture;27;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;2;Header(World Space Noise);Space;False;None;512fa11ad89d84543ad8d6c8d9cb6743;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;1262;-6228.192,2815.146;Float;False;Property;_MBAmplitudeOffset;MB Amplitude Offset;8;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;952;-6222.482,3461.336;Float;False;Property;_MBWindDirOffset;MB Wind Dir Offset;13;0;Create;True;0;0;0;False;0;False;20;0;0;180;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1482;-6221.055,3006.571;Inherit;False;Property;_MBFrequencyOffset;MB Frequency Offset;10;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;687;-6221.192,2627.146;Float;False;Property;_MBDefaultBending;MB Default Bending;6;0;Create;True;0;0;0;False;2;Header(Main Bending);Space;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;300;-6221.192,2722.146;Float;False;Property;_MBAmplitude;MB Amplitude;7;0;Create;True;0;0;0;False;1;Space;False;1.5;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;480;-6221.192,2910.146;Float;False;Property;_MBFrequency;MB Frequency;9;0;Create;True;0;0;0;False;1;Space;False;1.11;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1286;-6214.192,3096.146;Float;False;Property;_MBPhase;MB Phase;11;0;Create;True;0;0;0;False;1;Space;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1334;-6222.192,3566.146;Inherit;False;Property;_MBMaxHeight;MB Max Height;15;0;Create;True;0;0;0;False;1;Space;False;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;960;-2977.889,2753.048;Float;False;Property;_EnableVerticalBending;Enable Vertical Bending;16;0;Create;True;0;0;0;False;2;Header(Vertical Detail Bending);Space;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;1214;-2984.18,3020.163;Float;False;Property;_EnableHorizontalBending;Enable Horizontal Bending;22;0;Create;True;0;0;0;False;2;Header(Horizontal Detail Bending);Space;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;1265;642.2638,2687.529;Inherit;False;631.4954;512.0168;Comment;4;1061;296;1516;1517;Master Node;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1517;705.0869,2935.281;Inherit;False;Property;_Smoothness;Smoothness;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1458;-3873.645,1809.417;Float;True;Property;_PatternTex;Pattern Texture;1;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;None;50e8be33b1640034bbc8e6dacf43c1ee;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
WireConnection;1502;0;1533;1
WireConnection;1502;1;1533;3
...
WireConnection;1522;0;296;0
WireConnection;1522;4;1516;0
WireConnection;1522;7;1517;0
WireConnection;1522;11;1061;0
ASEEND*/
//CHKSM=0F881C05083CAC551FF156415622D7110F872E80