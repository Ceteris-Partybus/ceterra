	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 objToWorld1566 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float2 appendResult1506 = (float2(objToWorld1566.x , objToWorld1566.z));
				...
				float3 worldToObj35_g116 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(appendResult14_g116), 1 ) ).xyz;
				float3 worldToObj36_g116 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(float3( 0,0,0 )), 1 ) ).xyz;
				...
				float3 objToWorld52_g117 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float3 appendResult45_g118 = (float3(break62_g118.x , inputMesh.positionOS.y , break62_g118.z));
				float3 rotatedValue30_g118 = RotateAroundAxis( appendResult45_g118, inputMesh.positionOS, RotationAxis56_g118, RotationAngle54_g118 );
				float temp_output_4_0_g82 = radians( ( inputMesh.ase_color.b * 360.0 ) );
				...
				float3 objToWorld59_g97 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float DB_VerticalPhase1384 = _DBVerticalPhase;
				float3 appendResult12_g82 = (float3(0.0 , ( _UnitScale * inputMesh.ase_color.g ) , 0.0));
				...
				float3 rotatedValue29_g97 = RotateAroundAxis( PivotPosOnYAxis56_g97, inputMesh.positionOS, DB_RotationAxis757, radians( ( ( ( DB_VerticalAmplitude887 + ( DB_VerticalAmplitudeOffset1423 * ( 1.0 - PhaseShift48_g97 ) ) ) * sin( ( ( ( ( _TimeParameters.x ) * Fequency45_g97 ) - ( ( 2.0 * PI ) * PhaseShift48_g97 ) ) + ( ( ( objToWorld59_g97.x + objToWorld59_g97.z ) + ( ( _TimeParameters.x ) * Fequency45_g97 ) ) * DB_VerticalPhase1384 ) ) ) ) * ( distance( inputMesh.positionOS , PivotPosOnYAxis56_g97 ) / DB_VerticalMaxLength1388 ) ) ) );
				float VerticalBendingMask1524 = step( 1.0 , inputMesh.ase_texcoord.y );
				float3 DB_VerticalMovement1314 = ( ( rotatedValue29_g97 - inputMesh.positionOS ) * VerticalBendingMask1524 );
				...
				float3 objToWorld53_g96 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float DB_HorizontalPhase1401 = _DBHorizontalPhase;
				float3 PivotPoint49_g96 = float3( 0,0,0 );
				float3 break52_g96 = PivotPoint49_g96;
				float3 appendResult20_g96 = (float3(break52_g96.x , inputMesh.positionOS.y , break52_g96.z));
				float DB_HorizontalMaxRadius1403 = _DBHorizontalMaxRadius;
				float3 rotatedValue33_g96 = RotateAroundAxis( PivotPoint49_g96, inputMesh.positionOS, float3(0,1,0), radians( ( ( DB_HorizontalAmplitude1221 * sin( ( ( ( ( _TimeParameters.x ) * Frequency41_g96 ) - ( ( 2.0 * PI ) * ( 1.0 - DB_PhaseShift928 ) ) ) + ( ( ( objToWorld53_g96.x + objToWorld53_g96.z ) + ( ( _TimeParameters.x ) * Frequency41_g96 ) ) * DB_HorizontalPhase1401 ) ) ) ) * ( distance( inputMesh.positionOS , appendResult20_g96 ) / DB_HorizontalMaxRadius1403 ) ) ) );
				float HorizontalBendingMask1525 = step( 1.0 , inputMesh.ase_texcoord.x );
				float3 DB_SideToSideMovement1315 = ( ( rotatedValue33_g96 - inputMesh.positionOS ) * HorizontalBendingMask1525 );
				...
				float3 LocalVertexOffset1045 = ( ( rotatedValue34_g118 - inputMesh.positionOS ) * step( 0.01 , inputMesh.positionOS.y ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float DB_VerticalMaxLength1388 = _DBVerticalMaxLength;
				float3 rotatedValue29_g97 = RotateAroundAxis( PivotPosOnYAxis56_g97, inputMesh.positionOS, DB_RotationAxis757, radians( ( ( ( DB_VerticalAmplitude887 + ( DB_VerticalAmplitudeOffset1423 * ( 1.0 - PhaseShift48_g97 ) ) ) * sin( ( ( ( ( _TimeParameters.x ) * Fequency45_g97 ) - ( ( 2.0 * PI ) * PhaseShift48_g97 ) ) + ( ( ( objToWorld59_g97.x + objToWorld59_g97.z ) + ( ( _TimeParameters.x ) * Fequency45_g97 ) ) * DB_VerticalPhase1384 ) ) ) ) * ( distance( inputMesh.positionOS , PivotPosOnYAxis56_g97 ) / DB_VerticalMaxLength1388 ) ) ) );
				float VerticalBendingMask1524 = step( 1.0 , inputMesh.uv0.y );
				float3 DB_VerticalMovement1314 = ( ( rotatedValue29_g97 - inputMesh.positionOS ) * VerticalBendingMask1524 );
				#ifdef _ENABLEVERTICALBENDING_ON
				float3 staticSwitch960 = DB_VerticalMovement1314;
				#else
				...
				float DB_HorizontalMaxRadius1403 = _DBHorizontalMaxRadius;
				float3 rotatedValue33_g96 = RotateAroundAxis( PivotPoint49_g96, inputMesh.positionOS, float3(0,1,0), radians( ( ( DB_HorizontalAmplitude1221 * sin( ( ( ( ( _TimeParameters.x ) * Frequency41_g96 ) - ( ( 2.0 * PI ) * ( 1.0 - DB_PhaseShift928 ) ) ) + ( ( ( objToWorld53_g96.x + objToWorld53_g96.z ) + ( ( _TimeParameters.x ) * Frequency41_g96 ) ) * DB_HorizontalPhase1401 ) ) ) ) * ( distance( inputMesh.positionOS , appendResult20_g96 ) / DB_HorizontalMaxRadius1403 ) ) ) );
				float HorizontalBendingMask1525 = step( 1.0 , inputMesh.uv0.x );
				float3 DB_SideToSideMovement1315 = ( ( rotatedValue33_g96 - inputMesh.positionOS ) * HorizontalBendingMask1525 );
				#ifdef _ENABLEHORIZONTALBENDING_ON
				float3 staticSwitch1214 = DB_SideToSideMovement1315;
				#else
...
Node;AmplifyShaderEditor.RangedFloatNode;989;-5327.216,4134.123;Float;False;Property;_UnitScale;Unit Scale;27;0;Create;True;0;0;0;False;2;Header(Misc);Space;False;20;20;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;749;-5160.635,2633.756;Float;False;Property;_DBVerticalAmplitude;DB Vertical Amplitude;14;0;Create;True;0;0;0;False;1;Space;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;780;-5161.635,2825.756;Float;False;Property;_DBVerticalFrequency;DB Vertical Frequency;16;0;Create;True;0;0;0;False;1;Space;False;1.15;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;792;-5157.635,3018.756;Float;False;Property;_DBVerticalMaxLength;DB Vertical Max Length;18;0;Create;True;0;0;0;False;1;Space;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1220;-5158.635,3147.756;Float;False;Property;_DBHorizontalAmplitude;DB Horizontal Amplitude;20;0;Create;True;0;0;0;False;1;Space;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1249;-5158.635,3432.756;Float;False;Property;_DBHorizontalMaxRadius;DB Horizontal Max Radius;23;0;Create;True;0;0;0;False;1;Space;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1343;-5889.719,1538.76;Inherit;False;1402.304;768.1017;;8;1340;1344;1533;1500;1528;1457;1506;1566;World Space Noise;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TransformPositionNode;1566;-5814.602,1581.073;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;850;-5980.182,3205.127;Float;False;Property;_MBWindDir;MB Wind Dir;9;0;Create;True;0;0;0;False;1;Space;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1500;-5684.122,1782.174;Inherit;True;Property;_NoiseTexture;Noise Texture;24;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;2;Header(World Space Noise);Space;False;None;512fa11ad89d84543ad8d6c8d9cb6743;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;687;-5977.1,2629.025;Float;False;Property;_MBDefaultBending;MB Default Bending;3;0;Create;True;0;0;0;False;2;Header(Main Bending);Space;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;480;-5976.1,2917.024;Float;False;Property;_MBFrequency;MB Frequency;6;0;Create;True;0;0;0;False;1;Space;False;1.11;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;300;-5976.1,2725.024;Float;False;Property;_MBAmplitude;MB Amplitude;4;0;Create;True;0;0;0;False;1;Space;False;1.5;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1286;-5973.801,3097.725;Float;False;Property;_MBPhase;MB Phase;8;0;Create;True;0;0;0;False;1;Space;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1334;-5976.05,3563.617;Inherit;False;Property;_MBMaxHeight;MB Max Height;12;0;Create;True;0;0;0;False;1;Space;False;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;960;-2726.889,2875.661;Float;False;Property;_EnableVerticalBending;Enable Vertical Bending;13;0;Create;True;0;0;0;False;2;Header(Vertical Detail Bending);Space;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;1214;-2734.18,3146.163;Float;False;Property;_EnableHorizontalBending;Enable Horizontal Bending;19;0;Create;True;0;0;0;False;2;Header(Horizontal Detail Bending);Space;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;1265;1027.889,2563.993;Inherit;False;634.495;508.0168;;4;1495;1061;1496;296;Master Node;1,1,1,1;0;0
...
WireConnection;1506;0;1566;1
WireConnection;1506;1;1566;3
...
WireConnection;1555;0;296;0
WireConnection;1555;4;1495;0
WireConnection;1555;7;1496;0
WireConnection;1555;11;1061;0
ASEEND*/
//CHKSM=3AEA2A9E1858A4CCD676CA22B63809E7CFC5F173