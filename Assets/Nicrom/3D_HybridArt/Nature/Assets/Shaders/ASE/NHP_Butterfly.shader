	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord41 = inputMesh.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
						...
						)
			{
				...
				float2 uv_ColorMask1 = packedInput.ase_texcoord5.xy;
				...
				surfaceDescription.BaseColor = MainTextureColor2.rgb;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 texCoord41 = inputMesh.uv0.xy * float2( 1,1 ) + float2( 0,0 );
				float3 appendResult51 = (float3(0.0 , ( ( _Amplitude * sin( ( ( _TimeParameters.x ) * _Frequency ) ) ) * step( 0.6 , texCoord41.x ) ) , 0.0));
				float3 LocalVertexOffset17 = appendResult51;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_ColorMask1 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode1 = tex2D( _ColorMask, uv_ColorMask1 );
				float ColorMask_R25 = tex2DNode1.r;
				float4 lerpResult36 = lerp( float4( 0,0,0,0 ) , _Color1 , ColorMask_R25);
				float ColorMask_G30 = tex2DNode1.g;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_ColorMask1 = packedInput.ase_texcoord1.xy;
				float4 tex2DNode1 = tex2D( _ColorMask, uv_ColorMask1 );
				float Opacity3 = tex2DNode1.a;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_ColorMask1 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode1 = tex2D( _ColorMask, uv_ColorMask1 );
				float Opacity3 = tex2DNode1.a;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_ColorMask1 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode1 = tex2D( _ColorMask, uv_ColorMask1 );
				float ColorMask_R25 = tex2DNode1.r;
				float4 lerpResult36 = lerp( float4( 0,0,0,0 ) , _Color1 , ColorMask_R25);
				float ColorMask_G30 = tex2DNode1.g;
...
Node;AmplifyShaderEditor.CommentaryNode;54;-377.6145,-0.8588867;Inherit;False;636.7252;509.663;;4;5;4;18;55;Master Node;1,1,1,1;0;0
...
WireConnection;56;7;55;0
WireConnection;56;9;4;0
WireConnection;56;11;18;0
ASEEND*/
//CHKSM=54A380648659977C40FAFCD5D920957BBBD4335B