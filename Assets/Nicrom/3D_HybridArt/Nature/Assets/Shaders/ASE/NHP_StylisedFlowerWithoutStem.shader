...
Shader "Nicrom/NHP/ASE/Stylised Flower Without Stem"
{
	Properties
	{
		...
		[Space]_MBMaxHeight("MB Max Height", Float) = 0.5
		[Header(Rotation Around Local Pivot)][Space][Toggle(_ROTATIONAROUNDLOCALPIVOT_ON)] _RotationAroundLocalPivot("Rotation Around Local Pivot", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _ROTATIONAROUNDLOCALPIVOT_ON
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 objToWorld11_g65 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( LocalPivot1504, 1 ) ).xyz);
				...
				float3 worldToObj35_g86 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(appendResult14_g86), 1 ) ).xyz;
				float3 worldToObj36_g86 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(float3( 0,0,0 )), 1 ) ).xyz;
				...
				float3 objToWorld52_g85 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float3 appendResult45_g107 = (float3(break62_g107.x , inputMesh.positionOS.y , break62_g107.z));
				float3 rotatedValue30_g107 = RotateAroundAxis( appendResult45_g107, inputMesh.positionOS, RotationAxis56_g107, RotationAngle54_g107 );
				...
				float3 objToWorld53_g76 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float DB_HorizontalPhase1401 = _RotationPhase;
				float3 PivotPoint49_g76 = LocalPivot1504;
				float3 break52_g76 = PivotPoint49_g76;
				float3 appendResult20_g76 = (float3(break52_g76.x , inputMesh.positionOS.y , break52_g76.z));
				float DB_HorizontalMaxRadius1403 = _RotationMaxRadius;
				float3 rotatedValue33_g76 = RotateAroundAxis( PivotPoint49_g76, inputMesh.positionOS, float3(0,1,0), radians( ( ( DB_HorizontalAmplitude1221 * sin( ( ( ( ( _TimeParameters.x ) * Frequency41_g76 ) - ( ( 2.0 * PI ) * ( 1.0 - DB_PhaseShift928 ) ) ) + ( ( ( objToWorld53_g76.x + objToWorld53_g76.z ) + ( ( _TimeParameters.x ) * Frequency41_g76 ) ) * DB_HorizontalPhase1401 ) ) ) ) * ( distance( inputMesh.positionOS , appendResult20_g76 ) / DB_HorizontalMaxRadius1403 ) ) ) );
				#ifdef _ROTATIONAROUNDLOCALPIVOT_ON
				float3 staticSwitch1214 = ( ( rotatedValue33_g76 - inputMesh.positionOS ) * 1.0 );
				#else
				...
				float3 temp_output_1533_0 = ( ( rotatedValue34_g107 - inputMesh.positionOS ) * step( 0.01 , inputMesh.positionOS.y ) );
				float3 MainBending89_g108 = temp_output_1533_0;
				float3 appendResult15_g108 = (float3(0.0 , 1.0 , 0.0));
				float3 objToWorld98_g108 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( appendResult15_g108, 1 ) ).xyz);
				float3 objToWorld102_g108 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float3 objToWorld100_g108 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( appendResult3_g108, 1 ) ).xyz);
				float3 objToWorld106_g108 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float3 worldToObj99_g108 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(lerpResult26_g108), 1 ) ).xyz;
				float3 worldToObj105_g108 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(float3( 0,0,0 )), 1 ) ).xyz;
				...
				float3 rotatedValue35_g108 = RotateAroundAxis( LocalPivot1504, ( inputMesh.positionOS + MainBending89_g108 ), RotationAxis30_g108, RotationAngle29_g108 );
				float3 lerpResult52_g108 = lerp( MainBending89_g108 , ( rotatedValue35_g108 - inputMesh.positionOS ) , NaNPrevention21_g108);
...
Node;AmplifyShaderEditor.RangedFloatNode;850;-4950.607,3133.662;Float;False;Property;_MBWindDir;MB Wind Dir;12;0;Create;True;0;0;0;False;1;Space;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1218;-4152.895,2494.214;Float;False;Property;_RotationFrequency;Rotation Frequency;18;0;Create;True;0;0;0;False;0;False;1.16;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1308;-4151.895,2590.214;Float;False;Property;_RotationPhase;Rotation Phase;19;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1220;-4163.895,2394.214;Float;False;Property;_RotationAmplitude;Rotation Amplitude;17;0;Create;True;0;0;0;False;1;Space;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1249;-4152.895,2686.214;Float;False;Property;_RotationMaxRadius;Rotation Max Radius;20;0;Create;True;0;0;0;False;1;Space;False;0.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1546;-2845.371,2194.969;Inherit;True;Property;_NoiseTexture;Noise Texture;24;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;2;Header(World Space Noise);Space;False;None;512fa11ad89d84543ad8d6c8d9cb6743;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;687;-4953.004,2558.793;Float;False;Property;_MBDefaultBending;MB Default Bending;6;0;Create;True;0;0;0;False;2;Header(Main Bending);Space;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;300;-4954.004,2653.792;Float;False;Property;_MBAmplitude;MB Amplitude;7;0;Create;True;0;0;0;False;1;Space;False;1.5;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;480;-4954.004,2845.792;Float;False;Property;_MBFrequency;MB Frequency;9;0;Create;True;0;0;0;False;1;Space;False;1.11;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1286;-4950.607,3036.662;Float;False;Property;_MBPhase;MB Phase;11;0;Create;True;0;0;0;False;1;Space;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1334;-4947.97,3505.01;Inherit;False;Property;_MBMaxHeight;MB Max Height;15;0;Create;True;0;0;0;False;1;Space;False;0.5;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;1214;-2429.143,3112.848;Float;False;Property;_RotationAroundLocalPivot;Rotation Around Local Pivot;16;0;Create;True;0;0;0;False;2;Header(Rotation Around Local Pivot);Space;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1562;-4150.713,2790.191;Inherit;False;Property;_SlopeCorrectionMagnitude;Slope Correction Magnitude;22;0;Create;False;0;0;0;False;1;Space;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;1569;810.7398,2687.917;Float;False;Property;_EnableSlopeCorrection;Enable Slope Correction;21;0;Create;True;0;0;0;False;2;Header(Slope Correction);Space;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;1481;-462.4074,1794.486;Inherit;True;Property;_MainTex;Flower Texture;0;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;2;Header(Surface);Space;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.CommentaryNode;1265;1794.37,2047.332;Inherit;False;631.4954;512.0168;;3;1061;296;1508;Master Node;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1470;-4953.9,2453.023;Inherit;False;Property;_ColorBlendEnd;Color Blend End;4;0;Create;True;0;0;0;False;0;False;0.15;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1476;672.3386,1315.451;Inherit;False;Property;_FlowerColor2;Flower Color 2;2;0;Create;True;0;0;0;False;0;False;0.8980392,0.9529412,1,1;0.009433985,0.4014694,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
WireConnection;1584;0;296;0
WireConnection;1584;9;1508;0
WireConnection;1584;11;1061;0
ASEEND*/
//CHKSM=66AD795C7EE3DFD951085F8668D61F7B4E3A824E