...
Shader "Nicrom/NHP/ASE/Stylised Grass"
{
	Properties
	{
		...
		[NoScaleOffset][SingleLineTexture][Header(Surface)][Space]_MainTex("Main Tex", 2D) = "white" {}
		[Space]_Color1("Color 1", Color) = (0.3393185,0.490566,0.09255961,1)
		_Color2("Color 2", Color) = (0.719914,0.8207547,0.3639195,1)
		[Space]_ColorBlendStart("Color Blend Start", Range( 0 , 1)) = 0
		...
		[Space]_MBPhase("MB Phase", Float) = 3
		[Space]_MBMaxHeight("MB Max Height", Float) = 1
		[Header(Slope Correction)][Space][Toggle(_ENABLESLOPECORRECTION_ON)] _EnableSlopeCorrection("Enable Slope Correction", Float) = 1
		[Space]_SlopeCorrectionMagnitude("Slope Correction Magnitude", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord1502 = inputMesh.uv1.xy * float2( 1,1 ) + float2( 0,0 );
				float3 appendResult1503 = (float3(texCoord1502.x , 0.0 , texCoord1502.y));
				float3 Pivot1504 = -appendResult1503;
				float3 objToWorld11_g71 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( Pivot1504, 1 ) ).xyz);
				...
				float3 worldToObj35_g123 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(appendResult14_g123), 1 ) ).xyz;
				float3 worldToObj36_g123 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(float3( 0,0,0 )), 1 ) ).xyz;
				...
				float3 objToWorld52_g122 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float MB_RotationAngle97 = radians( ( ( ( ( MB_Amplitude880 + ( MB_AmplitudeOffset1356 * (StaticWorldNoise31_g122).x ) ) * sin( ( ( ( objToWorld52_g122.x + objToWorld52_g122.z ) + ( ( ( _TimeParameters.x ) * ( MB_Frequency873 + ( MB_FrequencyOffset1525 * (StaticWorldNoise31_g122).x ) ) ) + ( ( 2.0 * PI ) * DB_PhaseShift928 ) ) ) * MB_Phase1360 ) ) ) + MB_DefaultBending877 ) * ( inputMesh.positionOS.y / MB_MaxHeight1335 ) ) );
				float3 appendResult1539 = (float3(inputMesh.positionOS.x , 0.0 , inputMesh.positionOS.z));
				float3 rotatedValue1536 = RotateAroundAxis( appendResult1539, inputMesh.positionOS, MB_RotationAxis1420, MB_RotationAngle97 );
				float3 temp_output_1545_0 = ( ( rotatedValue1536 - inputMesh.positionOS ) * step( 0.01 , inputMesh.positionOS.y ) );
				float3 MainBending89_g183 = temp_output_1545_0;
				float3 appendResult15_g183 = (float3(0.0 , 1.0 , 0.0));
				float3 objToWorld98_g183 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( appendResult15_g183, 1 ) ).xyz);
				float3 objToWorld102_g183 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float3 break20_g183 = ( objToWorld98_g183 - objToWorld102_g183 );
				float3 appendResult24_g183 = (float3(-break20_g183.z , 0.0 , break20_g183.x));
				float3 appendResult3_g183 = (float3(0.0 , 1.0 , 0.0));
				float3 objToWorld100_g183 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( appendResult3_g183, 1 ) ).xyz);
				float3 objToWorld106_g183 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				float3 temp_output_107_0_g183 = ( objToWorld100_g183 - objToWorld106_g183 );
				float3 break108_g183 = temp_output_107_0_g183;
				float3 lerpResult84_g183 = lerp( float3(0,1,0) , temp_output_107_0_g183 , step( 0.001 , ( abs( break108_g183.x ) + abs( break108_g183.z ) ) ));
				float3 normalizeResult7_g183 = normalize( lerpResult84_g183 );
				float dotResult9_g183 = dot( normalizeResult7_g183 , float3(0,1,0) );
				float temp_output_12_0_g183 = acos( dotResult9_g183 );
				float NaNPrevention21_g183 = step( 0.01 , abs( ( temp_output_12_0_g183 * ( 180.0 / PI ) ) ) );
				float3 lerpResult26_g183 = lerp( float3(1,0,0) , appendResult24_g183 , NaNPrevention21_g183);
				float3 worldToObj99_g183 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(lerpResult26_g183), 1 ) ).xyz;
				float3 worldToObj105_g183 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(float3( 0,0,0 )), 1 ) ).xyz;
				float3 normalizeResult49_g183 = normalize( ( worldToObj99_g183 - worldToObj105_g183 ) );
				float3 RotationAxis30_g183 = normalizeResult49_g183;
				float SlopeCorrectionOffset1642 = _SlopeCorrectionOffset;
				float SlopeCorrectionMagnitude1570 = _SlopeCorrectionMagnitude;
				float RotationAngle29_g183 = ( saturate( ( (0.0 + ((StaticWorldSpaceNoise1340).x - 0.0) * (SlopeCorrectionOffset1642 - 0.0) / (1.0 - 0.0)) + SlopeCorrectionMagnitude1570 ) ) * temp_output_12_0_g183 );
				float3 rotatedValue35_g183 = RotateAroundAxis( Pivot1504, ( inputMesh.positionOS + MainBending89_g183 ), RotationAxis30_g183, RotationAngle29_g183 );
				float3 lerpResult52_g183 = lerp( MainBending89_g183 , ( rotatedValue35_g183 - inputMesh.positionOS ) , NaNPrevention21_g183);
				#ifdef _ENABLESLOPECORRECTION_ON
				float3 staticSwitch1565 = lerpResult52_g183;
				#else
						...
						)
			{
				...
				float2 uv_MainTex1481 = packedInput.ase_texcoord5.xy;
				float4 tex2DNode1481 = tex2D( _MainTex, uv_MainTex1481 );
				float MainTextureColor1487 = tex2DNode1481.r;
				float2 texCoord1547 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				surfaceDescription.BaseColor = Albedo1493.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_MainTex1481 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode1481 = tex2D( _MainTex, uv_MainTex1481 );
				float MainTextureColor1487 = tex2DNode1481.r;
				float2 texCoord1547 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult1550 = smoothstep( _ColorBlendStart , _ColorBlendEnd , texCoord1547.y);
				float4 lerpResult1480 = lerp( _Color2 , _Color1 , smoothstepResult1550);
				float4 Color1488 = lerpResult1480;
				float4 Albedo1493 = ( MainTextureColor1487 * Color1488 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float MB_WindDirection870 = lerpResult1653;
				float MB_WindDirectionOffset1373 = _MBWindDirOffset;
				float2 texCoord1502 = inputMesh.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float3 appendResult1503 = (float3(texCoord1502.x , 0.0 , texCoord1502.y));
				float3 Pivot1504 = -appendResult1503;
				float3 objToWorld11_g71 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( Pivot1504, 1 ) ).xyz);
				float2 appendResult10_g71 = (float2(objToWorld11_g71.x , objToWorld11_g71.z));
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_MainTex1481 = packedInput.ase_texcoord1.xy;
				float4 tex2DNode1481 = tex2D( _MainTex, uv_MainTex1481 );
				float Opacity1494 = tex2DNode1481.a;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_MainTex1481 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode1481 = tex2D( _MainTex, uv_MainTex1481 );
				float Opacity1494 = tex2DNode1481.a;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_MainTex1481 = packedInput.ase_texcoord7.xy;
				float4 tex2DNode1481 = tex2D( _MainTex, uv_MainTex1481 );
				float MainTextureColor1487 = tex2DNode1481.r;
				float2 texCoord1547 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult1550 = smoothstep( _ColorBlendStart , _ColorBlendEnd , texCoord1547.y);
				float4 lerpResult1480 = lerp( _Color2 , _Color1 , smoothstepResult1550);
				float4 Color1488 = lerpResult1480;
				float4 Albedo1493 = ( MainTextureColor1487 * Color1488 );
...
Node;AmplifyShaderEditor.RangedFloatNode;1651;-6352.832,2817.725;Float;False;Property;_MBWindDir;MB Wind Dir;11;0;Create;False;0;0;0;False;1;Space;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1556;-4923.387,3076.077;Inherit;True;Property;_NoiseTexture;Noise Texture;19;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;2;Header(World Space Noise);Space;False;None;512fa11ad89d84543ad8d6c8d9cb6743;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;687;-6353.188,2248.833;Float;False;Property;_MBDefaultBending;MB Default Bending;6;0;Create;True;0;0;0;False;2;Header(Main Bending);Space;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;300;-6353.188,2344.832;Float;False;Property;_MBAmplitude;MB Amplitude;7;0;Create;True;0;0;0;False;1;Space;False;1.5;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;480;-6353.188,2536.832;Float;False;Property;_MBFrequency;MB Frequency;9;0;Create;True;0;0;0;False;1;Space;False;1.11;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1286;-6349.79,2727.702;Float;False;Property;_MBPhase;MB Phase;14;0;Create;True;0;0;0;False;1;Space;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1334;-6353.02,3172.413;Inherit;False;Property;_MBMaxHeight;MB Max Height;15;0;Create;True;0;0;0;False;1;Space;False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1068;-3450.039,2307.786;Inherit;False;3576.668;1272.024;;34;1045;1565;1545;1572;1562;1643;1644;1544;1546;1542;1536;1541;1543;1539;1413;1421;1540;1538;1420;97;1586;1585;1378;1512;1366;1375;1370;1369;1526;1365;1376;1362;1367;1371;Main Bending;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1569;-6355.173,3266.013;Inherit;False;Property;_SlopeCorrectionMagnitude;Slope Correction Magnitude;17;0;Create;True;0;0;0;False;1;Space;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1676;-889.9186,3058.502;Inherit;False;SlopeCorrection - NHP;-1;;183;af38de3ca0adf3c4ba9b6a3dd482959e;0;5;87;FLOAT3;0,0,0;False;42;FLOAT;1;False;92;FLOAT;0;False;93;FLOAT4;0,0,0,0;False;41;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;1481;-1365.69,1843.528;Inherit;True;Property;_MainTex;Main Tex;0;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;2;Header(Surface);Space;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.StaticSwitch;1565;-450.904,2875.348;Float;False;Property;_EnableSlopeCorrection;Enable Slope Correction;16;0;Create;True;0;0;0;False;2;Header(Slope Correction);Space;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;1265;515.5881,2044.887;Inherit;False;631.4954;512.0168;;3;1061;296;1508;Master Node;1,1,1,1;0;0
...
WireConnection;1676;87;1545;0
WireConnection;1676;42;1572;0
WireConnection;1676;92;1643;0
WireConnection;1676;93;1644;0
WireConnection;1676;41;1562;0
WireConnection;1565;1;1545;0
WireConnection;1565;0;1676;0
...
WireConnection;1655;9;1508;0
WireConnection;1655;11;1061;0
ASEEND*/
//CHKSM=3EF4FEAFA8E9913136EE919BE43553FE118151C0